...
- Ecology state is an interpretability layer translating existing booleans into dominant horizon, volatility ecology, disagreement, timing profile, strike-level walls/pockets, sector/market overlays, and tail-risk flags that inform plan modifiers (confidence adjust, permission gating, sizing caps) without adding alpha.
